...
void UKF::Prediction(double delta_t) {
  ...
  //create augmented covariance matrix
	...
	//predict sigma points (sect21 lesson7)
	...
	//predict mean and covariance (sect 24 lesson7)
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
	...
	//store the incoming laser measurements
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
	...
	//set measurement dimension for rho, phi, rho_dot
	int n_z = 3;

	//create sigma points for raw measurement
	...
	//prediction for raw measurements
